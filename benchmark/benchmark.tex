...
\ior_open:NnTF \g_jsonparse_benchmark_ior { README.md } {
  \ior_map_inline:Nn \g_jsonparse_benchmark_ior {
    \tl_gset:Nn \g_jsonparse_benchmark_temp_tl {#1}
    \tl_greplace_all:Nno \g_jsonparse_benchmark_temp_tl { ~ } { \c_space_tl }
    \seq_gput_right:No \g_jsonparse_benchmark_file_data_seq { \g_jsonparse_benchmark_temp_tl }
    \tl_if_blank:nF {#1} {
