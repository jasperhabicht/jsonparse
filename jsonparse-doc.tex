...
|siunitx|
\end{macrodef}
The package can be loaded with the option \macro{siunitx}. This will add the letters e and E with category code 12 (``other'') to the list of exponent markers recognised by the \macro{siunitx} package making it possible to use the command \macro{\JSONParseExpandableValue} in combination with the macros provided by the \macro{siunitx} package.
