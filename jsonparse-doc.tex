...
\def\jsonparsefiledate{22 January 2025}
...
\changes{v1.0.2}{2025/01/22}{Support for Unicode surrogate pairs.}
...
\begin{macrodef}
|\jsonparse_unicode_combine_surrogates:nn| {<codepoint>} {<codepoint>}
\end{macrodef}
The command \macro{\jsonparse_unicode_combine_surrogates:nn} coverts a surrogate pair to the relevant codepoint. It takes as first argument the codepoint of the low surrogate and as second argument the codepoint of the high surrogate. It does not check whether the codepoints actually belong to the relevant ranges of codepoints for high and low surrogates.
