...
\changes{v1.6.6}{2025/08/27}{Various improvements. Added hook for preparsing.}
...
The package provides the hook \macro{jsonparse/preparse} using which code can be injected after the input string has been rescanned and immediately before the parsing starts. It can be used to manipulate the token list \macro{\g_jsonparse_json_tl} which holds the rescanned input string.
