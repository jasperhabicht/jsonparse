...
If this key is set locally as option to the commands \macro{\JSONParse} or \macro{\JSONParseFromFile}, it is necessary to also set it locally as option to the commands \macro{\JSONParseArrayUse}, \macro{\JSONParseArrayMapFunction} and \macro{\JSONParseArrayMapInline} to let the relevant mapping function start from the correct value of the internal counter.
