...
\def\jsonparsefileversion{1.6.0}
\def\jsonparsefiledate{10 May 2025}
...
\changes{v1.6.0}{2025/05/10}{Renaming of L3 functions.}
...
\end{macrodef}
The command \macro{\jsonparse_gset_parse:Nn} works in the very same way as the command \macro{\jsonparse_set_parse:Nn}, but the property list is set globally.
